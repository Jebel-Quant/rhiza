...
- **Release automation** — version bumping, OIDC PyPI publishing, Zenodo archiving metadata, optional grayskull conda recipe generation (`vars.PUBLISH_CONDA`, defaults to `true`), SLSA provenance
