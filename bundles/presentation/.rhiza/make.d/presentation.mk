...
.PHONY: require-marp presentation presentation-pdf presentation-serve

# ── Internal guard ───────────────────────────────────────────────────────────
# Ensure the Marp CLI is available, installing it via npm when possible; hard-fail
# with actionable guidance otherwise. Shared prerequisite for every presentation
# target (mirrors github.mk's require-gh pattern).
require-marp:
...
##@ Presentation
presentation:: require-marp ## generate presentation slides from PRESENTATION.md using Marp
...
presentation-pdf:: require-marp ## generate PDF presentation from PRESENTATION.md using Marp
...
presentation-serve:: require-marp ## serve presentation interactively with Marp
