...
# Generated by the gh-aw compiler alongside the .lock.yml files (it carries a
# DO-NOT-EDIT header); its content is owned by gh-aw, not by hand.
_GENERATED_WORKFLOWS = {"agentics-maintenance.yml"}


def _workflow_files() -> list[Path]:
    """Return every workflow file, rhiza's own and bundle-shipped stubs.

    Generated files (*.lock.yml and the gh-aw maintenance workflow, all
    compiled from gh-aw .md sources) are excluded: their content is owned by
    the gh-aw compiler, not by hand.
    """
